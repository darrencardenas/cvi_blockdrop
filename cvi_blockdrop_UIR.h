...
#define  PNLMAIN_BTNPLAYSOUND             6       /* control type: command, callback function: CB_BtnPlaySound */
...
#define  PNLMAIN_BTNROTATECW              10      /* control type: command, callback function: CB_BtnRotateCW */
...
int  CVICALLBACK CB_BtnPlaySound(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
